...
WebUI.setText(findTestObject('Other Cabang/Jayapura/UW/Rizky/InputDisposisi'), 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.')

WebUI.sendKeys(findTestObject('Other Cabang/Jayapura/UW/Rizky/InputDisposisi'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Other Cabang/Jayapura/UW/Rizky/InputPutusan'), 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.')

WebUI.sendKeys(findTestObject('Other Cabang/Jayapura/UW/Rizky/InputPutusan'), Keys.chord(Keys.ENTER))
