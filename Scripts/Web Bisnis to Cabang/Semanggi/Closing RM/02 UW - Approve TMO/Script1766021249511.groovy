...
WebUI.click(findTestObject('Other Cabang/Semanggi/UW/Dashboard/lastNextSubNumber'))
...
WebUI.scrollToElement(findTestObject('Other Cabang/Semanggi/UW/Ariq/iframe_Disposisi'), 0)

WebUI.delay(1)

WebUI.setText(findTestObject('Other Cabang/Semanggi/UW/Ariq/iframe_Disposisi'), 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.')

WebUI.sendKeys(findTestObject('Other Cabang/Semanggi/UW/Ariq/iframe_Disposisi'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Other Cabang/Semanggi/UW/Ariq/iframe_Putusan'), 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.')

WebUI.sendKeys(findTestObject('Other Cabang/Semanggi/UW/Ariq/iframe_Putusan'), Keys.chord(Keys.ENTER))

WebUI.scrollToElement(findTestObject('Underwriting/Approve TMO/inputLimit'), 0)

WebUI.click(findTestObject('Other Cabang/Semanggi/UW/Ariq/Dropdown Limit'))

WebUI.click(findTestObject('Other Cabang/Semanggi/UW/Ariq/PilihLimit1'))

WebUI.scrollToElement(findTestObject('Other Cabang/Semanggi/UW/Ariq/SecSubjectivity'), 0)

//Tambah Data Subjectivity
//Dok 1
WebUI.click(findTestObject('Other Cabang/Semanggi/UW/Ariq/BtnTambahSubject'))

WebUI.setText(findTestObject('Other Cabang/Semanggi/UW/Ariq/InputSubjectivityNote'), 'Dokumen Subject 1')

WebUI.setText(findTestObject('Other Cabang/Semanggi/UW/Ariq/Date1'), '12/18/2025')

WebUI.setText(findTestObject('Other Cabang/Semanggi/UW/Ariq/InputSubjectKet'), 'Subjectivity 1')

WebUI.uploadFile(findTestObject('Other Cabang/Semanggi/UW/Ariq/AttachSubject1'), 'C:/Users/ACER/Downloads/Sample Dokumen/samplepptx-2-1 (3)-1-1 (3).pptx')
...
WebUI.click(findTestObject('Other Cabang/Semanggi/UW/Ariq/SendSubject1'))
...
WebUI.setText(findTestObject('Other Cabang/Semanggi/UW/Ariq/InputSubjectivityNote'), 'Dokumen Subject 2')

WebUI.setText(findTestObject('Other Cabang/Semanggi/UW/Ariq/Date2'), '12/18/2025')

WebUI.setText(findTestObject('Other Cabang/Semanggi/UW/Ariq/InputSubjectKet'), 'Subjectivity 2')

WebUI.uploadFile(findTestObject('Other Cabang/Semanggi/UW/Ariq/AttachSubject2'), 'C:/Users/ACER/Downloads/Sample Dokumen/Monitoring Akseptasi COB.xlsx')
...
WebUI.click(findTestObject('Other Cabang/Semanggi/UW/Ariq/SendSubject2'))

WebUI.waitForAlert(10, FailureHandling.STOP_ON_FAILURE)

WebUI.acceptAlert()

WebUI.setText(findTestObject('Other Cabang/Semanggi/UW/Ariq/DateValidity'), '12/22/2025')

WebUI.scrollToElement(findTestObject('Other Cabang/Semanggi/UW/Ariq/Sec DokUnderwriting'), 0)

//Upload Dok Underwriting
//Dok 1
WebUI.click(findTestObject('Other Cabang/Semanggi/UW/Ariq/BtnTambahUnder'))

WebUI.setText(findTestObject('Other Cabang/Semanggi/UW/Ariq/InputNamaDokUnder'), 'Dokumen test 1')

WebUI.uploadFile(findTestObject('Other Cabang/Semanggi/UW/Ariq/AttachUnder1'), 'C:/Users/ACER/Downloads/Sample Dokumen/Legal Consent.docx')
...
WebUI.click(findTestObject('Other Cabang/Semanggi/UW/Ariq/SendUnder1'))
...
// Status Akseptasi
WebUI.scrollToElement(findTestObject('Other Cabang/Semanggi/UW/Ariq/Dropdown Akseptasi'), 0)

WebUI.click(findTestObject('Other Cabang/Semanggi/UW/Ariq/Dropdown Akseptasi'))

WebUI.click(findTestObject('Other Cabang/Semanggi/UW/Ariq/Pilih Akseptasi4'))
