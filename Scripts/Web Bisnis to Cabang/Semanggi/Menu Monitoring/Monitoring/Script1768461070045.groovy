...
String submissionNumber = 'BN57/2154/UND/FR-0201/SMG/01/26'

WebUI.setText(findTestObject('Other Cabang/Semanggi/Monitoring/InputSubmission'), 'BN57/2154/UND/FR-0201/SMG/01/26')
...
// Load Excel
ExcelData excelData = ExcelFactory.getExcelDataWithDefaultSheet(
	filePath,
	'Sheet1',
	false
)
...
if (submissionNumberExcel.equalsIgnoreCase(submissionNumber)) {
	...
	KeywordUtil.markFailed(
		"Submission Number TIDAK sesuai. Expected: " +
		submissionNumber + ", Actual: " + submissionNumberExcel
	)
}
