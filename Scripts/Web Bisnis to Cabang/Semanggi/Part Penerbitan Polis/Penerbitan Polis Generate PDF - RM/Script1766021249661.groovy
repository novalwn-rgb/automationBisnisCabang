...
WebUI.setText(findTestObject('Cabang/Bisnis Polis/input_Alamat Pengiriman'), 'Semanggi Permai 54321 RM')
...
WebUI.setText(findTestObject('Cabang/Bisnis Polis/input_Nama Pengirim'), 'Anrena RM')
