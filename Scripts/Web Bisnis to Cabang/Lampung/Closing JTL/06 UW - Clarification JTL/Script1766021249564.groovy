...
TestObject statusObject = findTestObject('Other Cabang/Lampung/UW/Ery/LastStatusPolis2')
...
WebUI.click(findTestObject('Other Cabang/Lampung/UW/Ery/LastSubDetail2'))

WebUI.scrollToElement(findTestObject('Other Cabang/Lampung/UW/Ery/SecForClarification'), 0)

WebUI.setText(findTestObject('Other Cabang/Lampung/UW/Ery/ClarificationInput Disposisi'), 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.')

WebUI.sendKeys(findTestObject('Other Cabang/Lampung/UW/Ery/ClarificationInput Disposisi'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Other Cabang/Lampung/UW/Ery/ClarificationInput Putusan'), 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.')

WebUI.sendKeys(findTestObject('Other Cabang/Lampung/UW/Ery/ClarificationInput Putusan'), Keys.chord(Keys.ENTER))

WebUI.delay(5)

WebUI.scrollToElement(findTestObject('Underwriting/Approve JTL/Btn Closing Instruction2'), 0)
