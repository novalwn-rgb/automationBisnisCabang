...
WebUI.click(findTestObject('Other Cabang/Lampung/Cabang/Robby Data Entry/Dropdown PemutusAkhir'))

WebUI.click(findTestObject('Other Cabang/Lampung/Cabang/Robby Data Entry/PilihOJS'))

WebUI.setText(findTestObject('Cabang/inputRemarks'), 'After Clarification JTL')

WebUI.click(findTestObject('Other Cabang/Lampung/Cabang/Robby Data Entry/BtnSubmit By Data Entry'))
