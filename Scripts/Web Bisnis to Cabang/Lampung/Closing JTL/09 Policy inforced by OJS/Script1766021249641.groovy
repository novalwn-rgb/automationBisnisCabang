...
WebUI.click(findTestObject('Other Cabang/Lampung/Cabang/Karisma Police Admin/Menu Approved'))

// Verify Status Penerbitan Polis
TestObject statusObject = findTestObject('Other Cabang/Lampung/Cabang/Karisma Police Admin/LastStatusPolis')
...
String expectedStatus = 'Policy inforced by OJS'
...
WebUI.click(findTestObject('Other Cabang/Lampung/Cabang/Karisma Police Admin/LastSubNum'))

WebUI.click(findTestObject('Other Cabang/Lampung/Cabang/Karisma Police Admin/Btn Issue Policy'))
