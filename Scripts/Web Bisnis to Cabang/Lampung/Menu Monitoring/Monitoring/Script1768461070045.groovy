...
WebUI.click(findTestObject('Other Cabang/Lampung/Bisnis/Menu Monitoring'))

WebUI.click(findTestObject('BusinessRM/closeInstallApp'))

String submissionNumber = 'BN57/2168/UND/WS-0202/TKG/01/26'

WebUI.setText(findTestObject('Other Cabang/Semanggi/Monitoring/InputSubmission'), 'BN57/2168/UND/WS-0202/TKG/01/26')
