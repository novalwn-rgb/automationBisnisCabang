...
WebUI.click(findTestObject('Other Cabang/Lampung/Cabang/Rizky OJS/Menu Disposisi'))

// Verify Status Penerbitan Polis
TestObject statusObject = findTestObject('Other Cabang/Lampung/Cabang/Rizky OJS/LastStatusPolis')
...
WebUI.click(findTestObject('Other Cabang/Lampung/Cabang/Rizky OJS/LastDetailDisposisi'))
