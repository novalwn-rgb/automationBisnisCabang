...
WebUI.setText(findTestObject('Cabang/Bisnis Polis/input_Alamat Pengiriman'), 'Jakarta1 Permai 54321 JTL')
...
WebUI.setText(findTestObject('Cabang/Bisnis Polis/input_Nama Pengirim'), 'Anrena Jakarta1 JTL')
