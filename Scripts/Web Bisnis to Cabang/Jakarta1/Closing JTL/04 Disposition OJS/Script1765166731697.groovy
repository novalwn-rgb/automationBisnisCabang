...
WebUI.setText(findTestObject('Cabang/Disposisi/PilihDisposisi'), 'Anisa Aulia')

WebUI.sendKeys(findTestObject('Cabang/Disposisi/PilihDisposisi'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Cabang/Disposisi/NoteDisposisi'), 'Disposisi ke Anisa')
