...
TestObject statusObject = findTestObject('Underwriting/Approve JTL/Dashboard/LastStatusPolis2')
...
WebUI.click(findTestObject('Underwriting/Approve JTL/Dashboard/LastSubDetail2'))
