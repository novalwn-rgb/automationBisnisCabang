...
WebUI.click(findTestObject('Padang/Cabang/Abi/MenuPP'))

WebUI.click(findTestObject('Padang/Cabang/Abi/SubMenuMonitor'))

WebUI.setText(findTestObject('Padang/Cabang/Abi/InputStatusPenerbitan'), 'Policy issued')

WebUI.sendKeys(findTestObject('Padang/Cabang/Abi/InputStatusPenerbitan'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Padang/Cabang/Abi/ButtonSearch Monitoring'))

// Verify Status Penerbitan Polis
TestObject statusObject = findTestObject('Padang/Cabang/Abi/LastStatusPolis Monitoring')
...
WebUI.click(findTestObject('Padang/Cabang/Abi/LastSubNum Monitoring'))
