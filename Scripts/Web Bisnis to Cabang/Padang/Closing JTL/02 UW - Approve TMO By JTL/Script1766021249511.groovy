...
WebUI.click(findTestObject('Padang/UW/Dashboard/lastNextSubNumber'))
...
WebUI.scrollToElement(findTestObject('Padang/UW/Tedi/SecSubjectivity'), 0)

//Tambah Data Subjectivity
//Dok 1
WebUI.click(findTestObject('Padang/UW/Tedi/BtnTambahSubject'))

WebUI.setText(findTestObject('Padang/UW/Tedi/InputSubjectivityNote'), 'Dokumen Subject 1')

WebUI.setText(findTestObject('Padang/UW/Tedi/Date1'), '12/18/2025')

WebUI.setText(findTestObject('Padang/UW/Tedi/InputSubjectKet'), 'Subjectivity 1')

WebUI.uploadFile(findTestObject('Padang/UW/Tedi/AttachSubject1'), 'C:/Users/ACER/Downloads/Sample Dokumen/samplepptx-2-1 (3)-1-1 (3).pptx')

WebUI.click(findTestObject('Padang/UW/Tedi/SendSubject1'))
...
WebUI.setText(findTestObject('Padang/UW/Tedi/InputSubjectivityNote'), 'Dokumen Subject 2')

WebUI.setText(findTestObject('Padang/UW/Tedi/Date2'), '12/18/2025')

WebUI.setText(findTestObject('Padang/UW/Tedi/InputSubjectKet'), 'Subjectivity 2')
...
WebUI.click(findTestObject('Padang/UW/Tedi/SendSubject2'))
...
WebUI.setText(findTestObject('Padang/UW/Tedi/InputSubjectivityNote'), 'Dokumen Subject 3')

WebUI.setText(findTestObject('Padang/UW/Tedi/Date3'), '12/18/2025')

WebUI.setText(findTestObject('Padang/UW/Tedi/InputSubjectKet'), 'Subjectivity 3')

WebUI.uploadFile(findTestObject('Padang/UW/Tedi/AttachSubject3'), 'C:/Users/ACER/Downloads/Sample Dokumen/Legal Consent.docx')

WebUI.click(findTestObject('Padang/UW/Tedi/SendSubject3'))

WebUI.waitForAlert(10, FailureHandling.STOP_ON_FAILURE)

WebUI.acceptAlert()

WebUI.setText(findTestObject('Underwriting/Approve TMO/inputDateValidity'), '12/18/2025')

WebUI.scrollToElement(findTestObject('Underwriting/Dokumen/Sec DokUnderwriting'), 0)

//Upload Dok Underwriting
//Dok 1
WebUI.click(findTestObject('Padang/UW/Tedi/BtnTambahUnder'))

WebUI.setText(findTestObject('Padang/UW/Tedi/InputNamaDokUnder'), 'Dokumen test 1')

WebUI.uploadFile(findTestObject('Padang/UW/Tedi/AttachUnder1'), 'C:/Users/ACER/Downloads/Sample Dokumen/samplepptx-2-1 (3)-1-1 (3).pptx')

WebUI.click(findTestObject('Padang/UW/Tedi/SendUnder1'))
