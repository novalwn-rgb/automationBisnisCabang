...
WebUI.click(findTestObject('Cabang/Heru/Menu PenerbitanPolis'))

WebUI.click(findTestObject('BusinessRM/closeInstallApp'))

WebUI.click(findTestObject('Padang/Cabang/Abi/Approved'))

// Verify Status Penerbitan Polis
TestObject statusObject = findTestObject('Padang/Cabang/Abi/LastStatusPolis')
...
WebUI.click(findTestObject('Padang/Cabang/Abi/LastSubNum'))

WebUI.click(findTestObject('Padang/Cabang/Abi/Btn Issue Policy'))
