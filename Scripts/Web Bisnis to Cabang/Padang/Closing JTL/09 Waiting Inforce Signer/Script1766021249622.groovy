...
WebUI.click(findTestObject('Padang/Cabang/Riska/Wait Inforce/Menu PenerbitanPolis'))

WebUI.click(findTestObject('BusinessRM/closeInstallApp'))

WebUI.click(findTestObject('Padang/Cabang/Riska/Wait Inforce/Approval'))

// Verify Status Penerbitan Polis
TestObject statusObject = findTestObject('Padang/Cabang/Riska/Wait Inforce/StatusPolis InforceSigner')
...
WebUI.click(findTestObject('Padang/Cabang/Riska/Wait Inforce/SubDetail'))

WebUI.scrollToElement(findTestObject('Padang/Cabang/Riska/Wait Inforce/SecRemarks'), 0)

WebUI.setText(findTestObject('Padang/Cabang/Riska/Wait Inforce/inputRemark'), 'Lanjut ke Abi')

WebUI.click(findTestObject('Padang/Cabang/Riska/Wait Inforce/Btn Approve'))
