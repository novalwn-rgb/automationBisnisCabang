...
TestObject statusObject = findTestObject('Padang/Cabang/Riska/LastStatusPolis')
...
WebUI.click(findTestObject('Padang/Cabang/Riska/LastDetailDisposisi'))
...
WebUI.click(findTestObject('Padang/Cabang/Riska/BtnSubmit Disposisi'))
