...
WebUI.click(findTestObject('Padang/Cabang/Riska/SubMenu Approval'))

// Verify Status Penerbitan Polis
TestObject statusObject = findTestObject('Padang/Cabang/Riska/StatusPolis Checking_Inforce')
...
WebUI.click(findTestObject('Padang/Cabang/Riska/SubDetail Checking_Inforce'))

WebUI.scrollToElement(findTestObject('Padang/Cabang/Riska/inputRemark By OJS'), 0)

WebUI.setText(findTestObject('Padang/Cabang/Riska/Pemutus Akhir By OJS'), 'OS')

WebUI.sendKeys(findTestObject('Padang/Cabang/Riska/Pemutus Akhir By OJS'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Padang/Cabang/Riska/inputRemark By OJS'), 'Lanjut ke Riska')

WebUI.click(findTestObject('Padang/Cabang/Riska/Send to Signer By OJS'))
