...
WebUI.setText(findTestObject('Underwriting/Login/inputEmail'), 'anisa.aulia')
...
TestObject statusObject = findTestObject('Cabang/Anisa/FirstStatusPolis')
...
WebUI.click(findTestObject('Cabang/Anisa/FirstSubDetail'))
...
WebUI.setText(findTestObject('Cabang/inputRemarks'), 'Testing Automation')
