...
WebUI.click(findTestObject('Cabang/Ria Approval Polis/SubDetail By Ria Approval Polis'))
...
WebUI.setText(findTestObject('Cabang/Ria Approval Polis/inputRemark By Ria Approval Polis'), 'Done testing Automation QA2')

WebUI.click(findTestObject('Cabang/Ria Approval Polis/BtnApprove By Ria Approval Polis'))
