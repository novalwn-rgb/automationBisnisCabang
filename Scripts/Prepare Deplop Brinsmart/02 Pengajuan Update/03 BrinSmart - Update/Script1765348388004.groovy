...
Mobile.tap(findTestObject('Brinsmart/FlowButton/Button - UpdateAktif'), 0)
...
Mobile.setText(findTestObject('Brinsmart/Sample Dokumen/InputNoteMessage'), 'Lanjut Update', 0)
