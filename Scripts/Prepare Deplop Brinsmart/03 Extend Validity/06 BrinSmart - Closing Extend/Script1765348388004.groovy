...
Mobile.setText(findTestObject('Brinsmart/FlowButton/InputCOB - Closing'), 'Closing Extend Done', 0)

Mobile.tap(findTestObject('Brinsmart/FlowButton/Button - SUBMITClosing'), 0)
