...
Mobile.tap(findTestObject('Brinsmart/FlowButton/Button - Extend Validity'), 0)
...
Mobile.tap(findTestObject('Brinsmart/Page 2/Frekuensi Claim/android.widget.TextView - 8'), 0)

Mobile.tap(findTestObject('Brinsmart/Page 2/BtnLanjutkan 2'), 0)

Mobile.scrollToText('Ajukan', FailureHandling.STOP_ON_FAILURE)

Mobile.setText(findTestObject('Brinsmart/Sample Dokumen/InputNoteMessage'), 'Lanjut Extend', 0)
