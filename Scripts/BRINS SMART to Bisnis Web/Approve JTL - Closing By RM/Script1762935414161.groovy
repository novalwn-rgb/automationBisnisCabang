...
//WebUI.setText(findTestObject('Subjectivity/Underwriting/New/SubDate 2'), '11/27/2025')
WebUI.setText(findTestObject('Subjectivity/Underwriting/Mira/DateSubject2'), '11/27/2025')
...
WebUI.setText(findTestObject('Subjectivity/Underwriting/Mira/DateSubject3'), '11/27/2025')
...
WebUI.setText(findTestObject('Subjectivity/Underwriting/Mira/DateSubject4'), '11/27/2025')
...
WebUI.setText(findTestObject('Subjectivity/Underwriting/Mira/DateSubject5'), '11/27/2025')
...
WebUI.setText(findTestObject('Subjectivity/Underwriting/New/SubDate 6'), '11/27/2025')

WebUI.setText(findTestObject('Subjectivity/Underwriting/Mira/DateSubject6'), 'Dokumen Sample 6')
...
WebUI.setText(findTestObject('Subjectivity/Underwriting/Mira/DateSubject7'), '11/27/2025')
...
//Checkbox berlaku ketika closing by RM
WebUI.click(findTestObject('Subjectivity/Underwriting/Mira/CheckBox1'))

WebUI.click(findTestObject('Subjectivity/Underwriting/Mira/CheckBox3'))

WebUI.click(findTestObject('Subjectivity/Underwriting/Mira/CheckBox5'))

WebUI.click(findTestObject('Subjectivity/Underwriting/Mira/CheckBox7'))
// Dok Putusan
...
WebUI.click(findTestObject('Putusan/CheckBoxDecision3'))

WebUI.click(findTestObject('Underwriting/Approve TMO/Decision By RM/Btn Submit Closing'))
