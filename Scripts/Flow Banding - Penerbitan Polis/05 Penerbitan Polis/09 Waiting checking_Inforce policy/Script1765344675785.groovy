...
WebUI.click(findTestObject('Cabang/Ikhsan/PP'))

//WebUI.click(findTestObject('BusinessRM/closeInstallApp'))
WebUI.click(findTestObject('Cabang/Ikhsan/Approval'))
...
WebUI.setText(findTestObject('Cabang/Ria Approval Polis/inputRemark By Ria Approval Polis'), 'Lanjut ke Agung')
