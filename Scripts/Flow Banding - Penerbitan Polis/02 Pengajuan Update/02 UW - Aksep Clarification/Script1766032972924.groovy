...
WebUI.uploadFile(findTestObject('Underwriting/BrinsToUW/Sekar/AttachSubject2'), 'C:/Users/ACER/Downloads/Sample Dokumen/Legal Consent.docx')
...
WebUI.click(findTestObject('Underwriting/input_Background Color_buttonBack'))
