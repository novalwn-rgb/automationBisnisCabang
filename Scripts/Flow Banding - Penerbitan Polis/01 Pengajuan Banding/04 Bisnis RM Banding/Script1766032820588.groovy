...
WebUI.scrollToElement(findTestObject('BusinessRM/BtnBanding'), 0)

WebUI.click(findTestObject('BusinessRM/BtnBanding'))

WebUI.setText(findTestObject('BusinessRM/MessageBanding'), 'Submit Banding')

WebUI.click(findTestObject('BusinessRM/SubmitBanding'))
