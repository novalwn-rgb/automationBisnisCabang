...
WebUI.click(findTestObject('Underwriting/Approve TMO/Decision By RM/Btn Closing Instruction'))

WebUI.setText(findTestObject('Underwriting/Approve TMO/Decision By RM/Note Closing'), 'Closing RM')
