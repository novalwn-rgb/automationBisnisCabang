...
Mobile.setText(findTestObject('Brinsmart/Login/InputEmail'), 'hendy.putra', 0)
...
Mobile.setText(findTestObject('Brinsmart/Page 1/InputTertanggung'), 'MobileToWeb - NonCaptive', 0)
