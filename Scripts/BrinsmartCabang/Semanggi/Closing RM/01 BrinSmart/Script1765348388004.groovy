...
Mobile.setText(findTestObject('Brinsmart/Login/InputEmail'), 'cob.semanggi.rm', 0)
...
Mobile.setText(findTestObject('Brinsmart/Page 1/InputTertanggung'), 'Brinsmart - NonCapt', 0)
