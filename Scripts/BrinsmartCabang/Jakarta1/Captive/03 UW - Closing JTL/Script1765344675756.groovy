...
WebUI.setText(findTestObject('Underwriting/BrinsToUW/Alfath/InputNamaDok Putusan'), 'Dokumen test 1')

WebUI.uploadFile(findTestObject('Underwriting/BrinsToUW/Alfath/AttachPutusan1'), 'C:/Users/ACER/Downloads/Sample Dokumen/samplepptx-2-1 (3)-1-1 (3).pptx')

WebUI.click(findTestObject('Underwriting/BrinsToUW/Alfath/SendPutusan1'))
