...
TestObject statusObject = findTestObject('Underwriting/Approve JTL/Dashboard/LastStatusPolis3')
...
WebUI.click(findTestObject('Underwriting/Approve JTL/Dashboard/LastSubDetail3'))

WebUI.scrollToElement(findTestObject('Underwriting/Approve JTL/SecFasterDecision2'), 0)

WebUI.setText(findTestObject('Underwriting/Approve TMO/Decision By RM/iframeDisposisi'), 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.')

WebUI.sendKeys(findTestObject('Underwriting/Approve TMO/Decision By RM/iframeDisposisi'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Underwriting/Approve TMO/Decision By RM/iframePutusan'), 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.')

WebUI.sendKeys(findTestObject('Underwriting/Approve TMO/Decision By RM/iframePutusan'), Keys.chord(Keys.ENTER))
