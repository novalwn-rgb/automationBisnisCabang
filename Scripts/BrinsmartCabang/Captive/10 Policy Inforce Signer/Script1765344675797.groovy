...
WebUI.click(findTestObject('Cabang/Heru/Approved'))

// Verify Status Penerbitan Polis
TestObject statusObject = findTestObject('Cabang/Heru/LastStatusPolis')
...
WebUI.click(findTestObject('Cabang/Heru/LastSubNum'))

//WebUI.scrollToElement(findTestObject('Cabang/Agung/SecRemarks'), 0)

WebUI.click(findTestObject('Cabang/Heru/Btn Issue Policy'))
