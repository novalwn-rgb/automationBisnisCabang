...
// run Mobile test
Mobile.callTestCase(findTestCase("Test Cases/Campur/tes"), null)

// run WebUI test while launching PC Chrome browser explicitly without calling WebUI.openBrowser('')
WebUI.callTestCase(findTestCase("Test Cases/BrinsmartCabang/Jakarta1/Captive/02 UW - Approve TMO"), null)